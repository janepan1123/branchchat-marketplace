...
- `THREAD_FORK_FAILED`: report whether the newly created worktree/branch were rolled back. If cleanup was incomplete, preserve every recovery path and command detail returned by the tool.
